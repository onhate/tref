        ...
        <div className="grid gap-4">
          ...
          >
            <div className="flex items-center justify-center w-full relative">
              ...
              {authClient.isLastUsedLoginMethod('email') && <LastUsedIndicator />}
            </div>
          </Button>
          ...
          >
            ...
            >
              ...
              {authClient.isLastUsedLoginMethod('google') && <LastUsedIndicator />}
            </Button>
            <Button
              variant="outline"
            ...
            >
              ...
              {authClient.isLastUsedLoginMethod('github') && <LastUsedIndicator />}
            </Button>
            <Button
              variant="outline"
              className={cn('w-full gap-2 flex items-center relative')}
